...
namespace BlazorCRUD.Server.Controllers
{
    ...
    public class CartController : ControllerBase
    {
        ...
        [HttpPost("add")]
        public async Task<ActionResult<ServiceResponse<bool>>> AddToCart([FromBody] CartItem cartItems)
        {
            //var userId = int.Parse(User.FindFirstValue(ClaimTypes.NameIdentifier));
        ...
        public async Task<ActionResult<ServiceResponse<bool>>> UpdateQuantity([FromBody] CartItem cartItems)
        {
            //var userId = int.Parse(User.FindFirstValue(ClaimTypes.NameIdentifier));
