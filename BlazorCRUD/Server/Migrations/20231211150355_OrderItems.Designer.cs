...
namespace BlazorCRUD.Server.Migrations
{
    ...
    [Migration("20231211150355_OrderItems")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BlazorCRUD.Shared.CartItem", b =>
                {
            ...
            modelBuilder.Entity("BlazorCRUD.Shared.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BlazorCRUD.Shared.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BlazorCRUD.Shared.OrderItem", b =>
                {
            ...
            modelBuilder.Entity("BlazorCRUD.Shared.ProductType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BlazorCRUD.Shared.ProductVariant", b =>
                {
                    b.Property<int>("ProductId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BlazorCRUD.Shared.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BlazorCRUD.Shared.OrderItem", b =>
                {
                    b.HasOne("BlazorCRUD.Shared.Order", "Order")
                        .WithMany("OrderItems")
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BlazorCRUD.Shared.Product", "Product")
                        .WithMany()
                        .HasForeignKey("ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BlazorCRUD.Shared.ProductType", "ProductType")
                        .WithMany()
            ...
            modelBuilder.Entity("BlazorCRUD.Shared.Product", b =>
                {
                    b.HasOne("BlazorCRUD.Shared.Category", "Category")
                        .WithMany()
